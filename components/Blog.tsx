...
export const Blog: React.FC = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      // xPercent/yPercent = 0 pins the image's top-left corner to the cursor position
  ...
  return (
    ...
    >
      ...
      <div
        ref={cursorRef}
        className={`fixed top-0 left-0 size-[13em] pointer-events-none z-[100] overflow-hidden rounded-2xl shadow-2xl transition-all duration-500 ease-out ${
          activeImage
